...
//    }
	...
	public static boolean isVideo(File file){
		if (getMIMEType(file).equals(str_video_type)){
			return true;
		}
		return false;
	}
...
//			temp.icon = resources.getDrawable(R.drawable.icon_folder);
//			temp.isDir = true;
//		}
//		else {
//			temp.isDir = false;
...
//    }
    ...
    public  static Drawable getDrawable(Context context,File file){
    	Drawable d = null;
		String tmp_type = getMIMEType(file);
		Resources resources = context.getResources();
    	if(tmp_type.equals(str_audio_type)){
    		d = resources.getDrawable(R.drawable.icon_music);
    		...
    		d = resources.getDrawable(R.drawable.icon_image);
    ...
    public static boolean isVideoFile(File tmp_file){
